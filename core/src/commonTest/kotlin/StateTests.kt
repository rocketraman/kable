...
public class StateTests {
    ...
    fun disconnecting_isAtLeast_connectingServices_is_false() {
        println("disconnecting_isAtLeast_connectingServices_is_false")
    ...
    fun connectingBluetooth_isAtLeast_disconnecting_is_true() {
        println("connectingBluetooth_isAtLeast_disconnecting_is_true")
    ...
    fun connectingBluetooth_isAtLeast_connectingBluetooth_is_true() {
        println("connectingBluetooth_isAtLeast_connectingBluetooth_is_true")
    ...
    fun connectingBluetooth_isAtLeast_connectingServices_is_false() {
        println("connectingBluetooth_isAtLeast_connectingServices_is_false")
    ...
    fun connectingBluetooth_isAtLeast_connectingObserves_is_false() {
        println("connectingBluetooth_isAtLeast_connectingObserves_is_false")
    ...
    fun connectingServices_isAtLeast_connectingBluetooth_is_true() {
        println("connectingServices_isAtLeast_connectingBluetooth_is_true")
    ...
    fun connectingServices_isAtLeast_connectingServices_is_true() {
        println("connectingServices_isAtLeast_connectingServices_is_true")
    ...
    fun connectingServices_isAtLeast_connectingObserves_is_false() {
        println("connectingServices_isAtLeast_connectingObserves_is_false")
    ...
    fun connectingObserves_isAtLeast_connectingBluetooth_is_true() {
        println("connectingObserves_isAtLeast_connectingBluetooth_is_true")
    ...
    fun connectingObserves_isAtLeast_connectingServices_is_true() {
        println("connectingObserves_isAtLeast_connectingServices_is_true")
    ...
    fun connectingObserves_isAtLeast_connectingObserves_is_true() {
        println("connectingObserves_isAtLeast_connectingObserves_is_true")
